    ...
    <center class="wrapper">
        <table role="presentation" class="email-container" width="100%" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td class="content">
                    <h1>Welcome, {{ $name }} 👋</h1>
                    <p>Thanks for joining — we’re thrilled to have you onboard. You’re all set to explore the best we
                        have to offer.</p>
            ...
            <tr>
                <td class="footer">
                    ...
                    <p style="margin:8px 0 0;font-size:12px;color:#9aa6b2">You’re receiving this email because you
                        signed up for If you didn’t, you can.</p>
                </td>
            </tr>
        </table>
    </center>
